...
public class BankAppDemo {
    ...
    public void runBankingDemo() throws IOException {
        // ---------------------------------------------------------
        // 1. SETUP: Simulate the Backend Server (Mocking the Cloud)
        // ---------------------------------------------------------
        ...
        authServer.setDispatcher(new Dispatcher() {
            ...
            public MockResponse dispatch(RecordedRequest request) {
                ...
                if (path.equals("/api/v1/auth/login")) {
                    // Simulate checking DB for user credentials
        ...
        // ---------------------------------------------------------
        // 2. INITIALIZATION: How a developer starts the SDK
        // ---------------------------------------------------------
        System.out.println("\n=== STARTING BANK APP DEMO ===\n");

        AuthConfig config = new AuthConfig.Builder()
                .baseUrl(authServer.url("").toString()) // In real app: "https://auth.bank.com"
        ...
        // ---------------------------------------------------------
        // 3. SCENARIO A: Regular User tries to access Vault
        // ---------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // 4. SCENARIO B: Admin User Login & 2FA Setup
        // ---------------------------------------------------------
        ...
        try {
            ...
            if (PermissionGuard.hasRole(admin, "ADMIN")) {
                ...
                // Security policy: Admins must enable MFA
